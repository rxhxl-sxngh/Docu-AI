        ...
        <nav class="h-screen w-64 fixed bg-white border-r border-neutral-200/30 hidden lg:block">
            <div class="flex flex-col h-full">
                ...
                <div class="flex-1 py-6">
                    ...
                    <a href="#upload" class="flex items-center px-6 py-3 text-neutral-600 hover:bg-neutral-100 transition-colors duration-200">
                    ...
                    <a href="#queue" class="flex items-center px-6 py-3 text-neutral-600 hover:bg-neutral-100 transition-colors duration-200">
                    ...
                    <a href="#results" class="flex items-center px-6 py-3 text-neutral-600 hover:bg-neutral-100 transition-colors duration-200">
                    ...
                    <a href="#logs" class="flex items-center px-6 py-3 text-neutral-600 hover:bg-neutral-100 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        Logs
                    </a>
                    <a href="#analytics" class="flex items-center px-6 py-3 text-neutral-600 hover:bg-neutral-100 transition-colors duration-200">
